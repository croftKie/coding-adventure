...
const LowerNav = ({openSettings, openClassroom, openLeaderboard, openChat, openProgress})=>{
        ...
        <div className="nav">
            ...
            <div className="lowerNav">
                <div>
                    ...
                    <div className="item"><img onClick={openChat} src={chat} alt="" /></div>
                </div>
                <h3>0 out of {chapters[currentChapter].chapterPuzzles.length} challenges completed</h3>
            </div>
            <div className="side-nav">
                <div className="item"><img onClick={openLeaderboard} src={podium} alt="" /></div>
                <div className="item"><img onClick={openProgress} src={process} alt="" /></div>
